...
(function () {
  ...
  App.pages.pharmacyDetails = {
    ...
    render(user, pharmacyId) {
      ...
      // 🛠️ (تعديل) قايمة الشهور المختصرة كانت طابقة بالغلط قايمة الشهور
      // الكاملة (نفس الأسماء بالظبط)، فمكانتش بتوفّر أي مساحة فعلية جوه
      // عمود الشارت الضيق على الموبايل. دلوقتي بقت أسماء مختصرة فعلاً.
